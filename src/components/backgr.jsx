...
export default function Background({ children }) {
    ...
    useEffect(() => {
        ...
        fetchFeaturedImages();
        const intervalId = setInterval(fetchFeaturedImages, 5000);
    ...
    return (
        <div className='relative min-h-screen'>
            ...
            {/* Image de fond */}
            <img src={featuredImage} alt='background image' className='absolute w-full h-full top-0 left-0 -z-20 object-cover' />
