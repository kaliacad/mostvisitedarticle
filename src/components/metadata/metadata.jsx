...
export default function Metadata() {
    return (
        <Helmet>
            ...
            <meta
                name='description'
                content="Cette application nous permet d'afficher les articles wikipedia les plus  lus selon un certain nombre de filtres : selon les pays ,selon les dates  ..."
            />
            {/* description */}
            <meta name='keybord' content='Emi, Wikipedia, les articles les plus visités' /> {/* CEO */}
